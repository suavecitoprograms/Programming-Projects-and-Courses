...
class Collector():
    ...
    def draw_window(self):
        ...
        #increasing difficulty every 30 coins collected
        ...
        if self.game_over:
            ...
            game_text = self.game_font.render(f"level achieved: {self.level}", True, (255,255,255))
            self.window.blit(game_text,  (self.width//2 - game_text.get_width()//2, self.height//2 - game_text.get_height()//2 + 50))
            game_text = self.game_font.render(f"high score: {self.high_score}", True, (255,255,255))
